...
public class KafkaProducerApp {
    ...
    public static void main(String[] args) {
        ...
        // Дополнительные настройки из файла (если есть)
        ...
        try (KafkaProducer<String, String> producer = new KafkaProducer<>(props)) {
            ...
            for (int i = 1; i <= messagesCount; i++) {
                try {
                    ...
                    // Отправляем и ждем подтверждение
                    ...
                    log.error("✗ Ошибка при отправке сообщения {}: {}", i, e.getMessage());
                    errorCount++;
                }
            }
    ...
    private static Data generateRandomData(int id) {
        ...
        data.setType(TransactionType.values()[random.nextInt(TransactionType.values().length)]);
